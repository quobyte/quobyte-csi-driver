...
// kind-tests/e2e-sanity-tests/README.md.
//
...
//     github.com/kubernetes-csi/external-snapshotter/client/v8 to kind-tests/go.mod, or
...
func TestSnapshotRestoresVolumeContent(t *testing.T) {
	t.Skip("not implemented yet -- see the TODO list in kind-tests/e2e-sanity-tests/README.md")
}
